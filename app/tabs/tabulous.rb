...
Tabulous.setup do |config|
  ...
  config.tabs do
    [
      ...
      #------------------------------------------------------------------------------------------------------------------------#
      [    :category_tab          ,    'Category'          ,    category_index_path          ,    true        ,    true        ],
      [    :sub_categories_tab    ,    'Sub Categories'    ,    sub_categories_index_path    ,    true        ,    true        ],
      [    :categories_tab        ,    'Categories'        ,    root_path                    ,    true        ,    true        ],
  ...
  config.actions do
    [
      ...
      #------------------------------------------------------------------------#
      [    :category          ,    :all_actions    ,    :category_tab          ],
      [    :sub_categories    ,    :all_actions    ,    :sub_categories_tab    ],
